...
(function() {
  (function($, window, document) {
    ...
    Plugin.prototype._isFirst = function() {
      if (this.data.current === 0) {
        return true;
      }
      return false;
    };
    Plugin.prototype._isLast = function() {
      if (this.data.total === this.data.current + 1) {
        return true;
      }
      return false;
    };
    ...
    Plugin.prototype.next = function(effect) {
      var $element;
      this.data = $.data(this);
      if (this.options.finity && this._isLast()) {
        return;
      }
      $element = $(this.element);
    ...
    Plugin.prototype.previous = function(effect) {
      var $element;
      this.data = $.data(this);
      if (this.options.finity && this._isFirst()) {
        return;
      }
      $element = $(this.element);
    ...
    Plugin.prototype._back = function(slidesControl) {
      var duration, prefix, timing, transform;
      prefix = this.data.vendorPrefix;
      transform = prefix + "Transform";
      duration = prefix + "TransitionDuration";
      timing = prefix + "TransitionTimingFunction";
      slidesControl[0].style[transform] = "translateX(0px)";
      return slidesControl[0].style[duration] = this.options.effect.slide.speed * 0.85 + "ms";
    };
